...
public class SmsLogAdapter extends BaseAdapter {
	...
	private ArrayList<Sms> arrItem;
	private int mLayout;
	private ImageLoader imageLoader;
	
	public SmsLogAdapter(Context context, int layout, ArrayList<Sms> item) {
		mContext = context;
	...
	public void updateItem(ArrayList<Sms> diaryArr) {
		arrItem.clear();
