...
public class NavigationDrawerFragment extends Fragment {
	...
	public void setUp(int fragmentId, DrawerLayout drawerLayout) {
		...
		// actionBar.setBackgroundDrawable(new ColorDrawable(Color.rgb(39, 167,
		// 255)));
	...
	private void selectItem(int position, int childPosition) {
		boolean isExapandable = false;
		if (mDrawerListView != null) {
			mDrawerListView.setItemChecked(position, true);
		}
		if (mCallbacks != null) {
			isExapandable = mCallbacks.onNavigationDrawerItemSelected(position, childPosition);
		}
		if (mDrawerLayout != null && isExapandable == false) {
